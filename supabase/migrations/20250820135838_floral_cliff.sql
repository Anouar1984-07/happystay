/*
  ...
  1. Modifications
    - Supprimer l'ancienne fonction pour éviter les conflits de type
    - Recréer avec le bon type de retour (bigint au lieu d'integer pour available)
  ...
  2. Nouvelle logique
    ...
    - Utiliser bigint pour available car COUNT(*) retourne bigint
*/

-- Supprimer l'ancienne fonction pour éviter les conflits de type de retour
DROP FUNCTION IF EXISTS get_available_slots(date);

-- Recréer la fonction avec le bon type de retour (bigint pour available)
